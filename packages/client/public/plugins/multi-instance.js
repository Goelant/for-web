...
const {render: render$1,Portal,Dynamic,template,delegateEvents,insert,spread,effect,memo,style,classList,use,createComponent,setAttribute,addEventListener,innerHTML} = mod$1;
...
var _tmpl$$1 = /* @__PURE__ */ template(`<p>`), _tmpl$2 = /* @__PURE__ */ template(`<div><label>Instance URL</label><input placeholder=https://example.com><div><button>Cancel</button><button>`), _tmpl$3 = /* @__PURE__ */ template(`<p>Could not validate the instance (CORS). Login may still work.`), _tmpl$4 = /* @__PURE__ */ template(`<div><p>Logging into <strong></strong></p><input type=email placeholder=Email><input type=password placeholder=Password><div><button>Back</button><button>`), _tmpl$5 = /* @__PURE__ */ template(`<p>Connected successfully! Closing...`), _tmpl$6 = /* @__PURE__ */ template(`<div><div><h2>Add an Instance`);
...
function AddInstanceOverlay(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      ...
      _el$.style.setProperty("background", "rgba(0,0,0,0.5)");
      _el$2.style.setProperty("background", "var(--md-sys-color-surface-container-high)");
      _el$2.style.setProperty("border-radius", "16px");
      _el$2.style.setProperty("padding", "24px");
      _el$2.style.setProperty("min-width", "380px");
      _el$2.style.setProperty("max-width", "440px");
      _el$2.style.setProperty("color", "var(--md-sys-color-on-surface)");
      _el$3.style.setProperty("margin", "0 0 16px 0");
      ...
      insert(_el$2, createComponent(Show, {
        ...
        get children() {
          var _el$4 = _tmpl$2(), _el$5 = _el$4.firstChild, _el$6 = _el$5.nextSibling, _el$8 = _el$6.nextSibling, _el$9 = _el$8.firstChild, _el$0 = _el$9.nextSibling;
          _el$4.style.setProperty("display", "flex");
          _el$4.style.setProperty("flex-direction", "column");
          _el$4.style.setProperty("gap", "12px");
          _el$6.$$keydown = (e) => {
          ...
          insert(_el$4, createComponent(Show, {
            ...
            get children() {
              var _el$7 = _tmpl$$1();
              _el$7.style.setProperty("color", "var(--md-sys-color-error)");
              _el$7.style.setProperty("margin", "0");
              insert(_el$7, error);
              return _el$7;
            }
          }), _el$8);
          _el$8.style.setProperty("display", "flex");
          _el$8.style.setProperty("gap", "8px");
      ...
      insert(_el$2, createComponent(Show, {
        ...
        get children() {
          ...
          _el$1.style.setProperty("gap", "12px");
          _el$10.style.setProperty("margin", "0");
          ...
          insert(_el$1, createComponent(Show, {
            ...
            get children() {
              var _el$13 = _tmpl$3();
              _el$13.style.setProperty("color", "var(--md-sys-color-tertiary)");
              _el$13.style.setProperty("margin", "0");
          ...
          insert(_el$1, createComponent(Show, {
            ...
            get children() {
              var _el$16 = _tmpl$$1();
              _el$16.style.setProperty("color", "var(--md-sys-color-error)");
              _el$16.style.setProperty("margin", "0");
              insert(_el$16, error);
              return _el$16;
            }
          }), _el$17);
          _el$17.style.setProperty("display", "flex");
          _el$17.style.setProperty("gap", "8px");
          _el$17.style.setProperty("justify-content", "flex-end");
          _el$18.$$click = () => {
            setStep("url");
            setError("");
          };
      ...
      insert(_el$2, createComponent(Show, {
        ...
        get children() {
          var _el$20 = _tmpl$5();
          _el$20.style.setProperty("color", "var(--md-sys-color-primary)");
          return _el$20;
        }
      }), null);
      return _el$;
...
const plugin = {
  ...
  async setup(api) {
    ...
    api.registerClientResolver((entityId) => {
